...
export default function Footer() {
  ...
  const footerLinks: Record<string, { label: string; href: string; external?: boolean }[]> = {
    ...
    [t('footer_cat_community')]: [
      ...
      { label: 'Singapore', href: '/tradiglo.singapore' },
      { label: 'Bahrain', href: '/tradiglo.bahrain' },
      { label: 'Jordania', href: '/tradiglo.jordan' },
      { label: 'Brunei', href: '/tradiglo.brunei' },
      { label: 'Oman', href: '/tradiglo.oman' },
      { label: 'Kuwait', href: '/tradiglo.kuwait' },
