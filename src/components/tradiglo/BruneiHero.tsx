...
const WA_ADMIN =
  'https://wa.me/60147792325?text=Hi%20Tradiglo%2C%20saya%20berminat%20untuk%20daftar.%20Saya%20dari%20Brunei%20Darussalam%20dan%20ingin%20tahu%20cara%20bermula%20dengan%20Tradiglo.';
...
export default function BruneiHero() {
  ...
  const trackChannel = () => {
    if (typeof window !== 'undefined') (window as any).gtag?.('event', 'click_whatsapp_channel_bn', { location: 'hero' });
  };
  const trackAdmin = () => {
    if (typeof window !== 'undefined') (window as any).gtag?.('event', 'click_whatsapp_admin_bn', { location: 'hero' });
  };
          ...
          <div className="space-y-6 order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                aria-label="Sertai Telegram Group Tradiglo Brunei"
              >
