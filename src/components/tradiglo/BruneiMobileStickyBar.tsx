...
export default function BruneiMobileStickyBar() {
  const trackChannel = () => {
    if (typeof window !== 'undefined') (window as any).gtag?.('event', 'click_mobile_sticky_channel_bn');
  };
  const trackAdmin = () => {
    if (typeof window !== 'undefined') (window as any).gtag?.('event', 'click_mobile_sticky_admin_bn');
  };
