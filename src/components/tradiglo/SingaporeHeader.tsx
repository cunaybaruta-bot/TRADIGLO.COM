    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          {/* Logo */}
          <a href="/tradiglo.singapore" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="text-[9px] text-violet-400/60 tracking-[0.25em] uppercase font-semibold">Singapore</span>
            </div>
          </a>
