...
export default function SingaporeRegistrationSection() {
  ...
  const validate = () => {
    ...
    if (!form.agree) e.agree = 'You must agree before proceeding.';
    return e;
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setErrors({});
    setLoading(true);
    if (typeof window !== 'undefined') (window as any).gtag?.('event', 'submit_registration_form_sg');
    const capitalText = form.capital ? `\nEstimated Capital: ${form.capital}` : '';
    const msg = `Hi Tradiglo, I am interested to register.\n\nName: ${form.name}\nWhatsApp Number: ${form.whatsapp}\nExperience Level: ${form.experience}\nMarket of Interest: ${form.market}${capitalText}\n\nI would like to get started with Tradiglo Singapore.`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6 lg:sticky lg:top-24">
            ...
            >
              <span className="text-xs font-bold uppercase tracking-wider" style={{ color: '#8B5CF6' }}>Registration</span>
            </div>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">
              ...
              >
                WhatsApp Admin Singapore
              </span>
            </h2>
            <p className="text-[#A6A8C3] leading-relaxed">
              If you need onboarding, guidance on reading Crypto, Forex, or Gold signals — or more information about Tradiglo, contact WhatsApp Admin Singapore.
            </p>
            <div
              className="p-5 rounded-2xl space-y-3"
              style={{ background: '#11143A', border: '1px solid rgba(139,92,246,0.2)' }}
            >
              <p className="text-xs font-bold text-white uppercase tracking-wider">What you will receive:</p>
              <ul className="space-y-2">
                {[
                  'Guide to reading Crypto, Forex & Gold signals',
                  'Basic trading onboarding',
                  'More information about Tradiglo',
                  'Support from Singapore Admin',
                ].map((item) => (
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div>
                <label className="block text-xs font-semibold text-[#A6A8C3] mb-1.5">
                  Trading Experience Level <span className="text-red-400">*</span>
                </label>
                <select
                ...
                >
                  <option value="" disabled className="text-[#A6A8C3]/40">Select experience level</option>
              ...
              <div>
                <label className="block text-xs font-semibold text-[#A6A8C3] mb-1.5">
                  Market of Interest <span className="text-red-400">*</span>
                </label>
                <select
                  value={form.market}
                ...
                >
                  <option value="" disabled className="text-[#A6A8C3]/40">Select market</option>
              ...
              <div>
                <label className="block text-xs font-semibold text-[#A6A8C3] mb-1.5">
                  Estimated Capital <span className="text-[#A6A8C3]/50">(Optional)</span>
                </label>
                <select
                  value={form.capital}
                ...
                >
                  ...
                  <option value="Less than SGD 500">Less than SGD 500</option>
                  <option value="SGD 500 - SGD 1,000">SGD 500 – SGD 1,000</option>
                  <option value="SGD 1,000 - SGD 5,000">SGD 1,000 – SGD 5,000</option>
                  <option value="More than SGD 5,000">More than SGD 5,000</option>
                </select>
              </div>
              ...
              <div>
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-xs text-[#A6A8C3] leading-relaxed">
                    I understand that trading involves risk and Tradiglo does not guarantee profits.
                  </span>
                </label>
