        ...
        <div style={{ borderTop: '1px solid rgba(139,92,246,0.1)' }} className="pt-8 space-y-5">
          ...
          >
            <p className="text-[11px] text-[#A6A8C3]/50 leading-relaxed">
              <span className="font-semibold text-[#A6A8C3]/70">Penafian Risiko:</span>{' '}
              Trading Forex, Gold, Crypto, CFD, dan instrumen berleveraj melibatkan risiko tinggi dan mungkin tidak sesuai untuk semua individu. Prestasi lepas tidak menjamin keputusan masa depan. Tradiglo tidak memberikan nasihat kewangan peribadi, tidak mengurus dana pengguna, dan tidak menjamin sebarang keuntungan. Pengguna bertanggungjawab sepenuhnya terhadap keputusan trading masing-masing.
            </p>
          </div>
